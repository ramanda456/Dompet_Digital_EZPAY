...
class BannerPromo1Page3 extends StatelessWidget {
  const BannerPromo1Page3({Key? key}) : super(key: key);
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Judul promo
                  const Text(
                    "(NEW USER) CASHBACK GACOR BAYAR TAGIHAN PDAM",
                    style: TextStyle(
                      fontWeight: FontWeight.bold,
                      fontSize: 15,
                    ),
                  ...
                  const Text(
                    ...
                    "3. Dapatkan cashback sebesar 10.000 Poin Cash untuk setiap transaksi pembayaran tagihan PDAM minimal Rp100.000 menggunakan aplikasi EZ Pay.\n\n"
