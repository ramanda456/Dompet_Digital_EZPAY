...
class BannerPromo1Page1 extends StatelessWidget {
  const BannerPromo1Page1({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          // Header dengan gradient hijau ke biru
          Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    ...
                    "3. Dapatkan cashback sebesar 10.000 Poin Cash untuk setiap transaksi pembayaran tagihan BPJS minimal Rp100.000 menggunakan aplikasi EZ Pay.\n\n"
